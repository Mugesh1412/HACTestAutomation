...
public class HomePage extends ReusableUtility {
	...
	public void createNewCustomerAccount(String Accountname, String Industry, String Address ) throws InterruptedException {
	...
	public boolean compareShippingAddressAndBillingAddressOnTheAccount() throws InterruptedException {

		Thread.sleep(10000); 
		scroolByPixelValue(0, 600); 
		Thread.sleep(1000); String
		BillingAddress = driver.findElement(By.xpath("//span[text()='Billing Address']/../../..//a")).getText();
